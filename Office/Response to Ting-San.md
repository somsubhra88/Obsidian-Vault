...
Final Purchase means we have successfully acquired that customer, and from that point in time, our approach will change. Our focus will move towards retention of that customer by engaging them, e.g. pop up messages, email capmpaigns
