...
\end{align}
$$
Assume that we have a neural network to represent the Q-function, Qθ. In TD learning, Qtπar(st, at) is derived by estimating the right-hand side of Equation 3.8 using Qθ. At each training iteration, ˆ Qπ(st, at) is updated to bring it closer to Qtπar(st, at).