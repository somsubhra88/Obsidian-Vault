...
## Dynamic Pricing
The elasticity of a product is defined as $\gamma = \frac{\partial Q / Q}{\partial P / P}$, where Q is the sales quantity and P is the sales price of the product. of the after taking the denominator in the other side and doing intergration and little bit of manupulation we can express this equation this way - $Q=CP^\gamma$ 