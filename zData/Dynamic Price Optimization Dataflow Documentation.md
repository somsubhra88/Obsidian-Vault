...
- Price of each product should not go beyond 10% of the base price and below 5%, i.e. $P_{i,t} \le 1.10 \cdot B_i \; \; \& \; \; P_{i,t} \ge 0.95 B_i \; \; \forall i \in \Omega$, where $B_i$ is the 