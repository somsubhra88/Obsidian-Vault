...
During the retention phase we will be concentrate on providing appropriate discounts, Offers etc. We have two options here - we can give uniform discounts to every or personalize the discounts based on customer profile and our historical interaction with the customer(e.g. number of ads shown, number of email campaigns etc.).
