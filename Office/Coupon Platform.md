...
### Coupons Data
As of now, we are not sure about the kind of data available for coupons. We are making some assumptions to make the proposal, but we can obviously tweak the algorithm based on the data availbility